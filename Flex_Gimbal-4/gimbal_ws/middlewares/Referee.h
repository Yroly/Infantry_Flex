...
#define RED_ENGINEER  2
 ...
 #define GAME_STATUS  0x0001    // 比赛状态数据
 #define GAME_RESULT  0x0002    // 比赛结果数据
 #define GAME_ROBOT_HP  0x0003  // 比赛机器人血量数据

 #define EVENT_DATA  0x0101       // 场地事件数据
 #define REFEREE_WARNING  0x0104  // 裁判警告数据
 #define DART_INFO  0x0105        // 飞镖发射相关数据

 #define ROBOT_STATUS  0x0201           // 机器人性能体系数据
 #define POWER_HEAT_DATA  0x0202        // 实时底盘缓冲能量和射击热量数据
 #define ROBOT_POS  0x0203              // 机器人位置数据
 #define BUFF  0x0204                   // 机器人增益数据
                                                    // 没有0x0205
 #define HURT_DATA  0x0206              // 伤害状态数据
 #define SHOOT_DATA  0x0207             // 实时射击数据
 #define PROJECTILE_ALLOWANCE  0x0208   // 允许发弹量
 #define RFID_STATUS  0x0209            // 机器人RFID模块状态
 #define DART_CLIENT_CMD  0x020A        // 飞镖选手端指令数据
 #define GROUND_ROBOT_POSITION  0x020B  // 地面机器人位置数据
 #define RADAR_MARK_DATA  0x020C        // 雷达标记进度数据
 #define SENTRY_INFO  0x020D            // 哨兵自主决策信息同步
 #define RADAR_INFO  0x020E             // 雷达自主决策信息同步

 #define ROBOT_INTERACTION_DATA  0x0301  // 机器人交互数据
 #define CUSTOM_ROBOT_DATA  0x0302       // 自定义控制器与机器人交互数据 图传链路
 #define MAP_COMMAND  0x0303             // 选手端小地图交互数据
 #define MAP_ROBOT_DATA  0x0305          // 选手端小地图接收雷达数据
 #define CUSTOM_CLIENT_DATA  0x0306      // 自定义控制器与选手端交互数据
 #define MAP_DATA 0x0307                // 选手端小地图接收哨兵数据
 #define CUSTOM_INFO  0x0308             // 选手端小地图接收机器人数据
 #define ROBOT_CUSTOM_DATA  0x0309       // 自定义控制器接收机器人数据 图传链路
 #define ROBOT_CLIENT_DATA  0x0310       // 机器人发送给自定义客户端的数据 图传链路
 #define SET_IMAGE_TRANSFER  0x0F01      //设置图传出图信道 图传链路
 #define INQUIRY_IMAGE_TRANSFER  0x0F02  //查询图传出图信道 图传链路

 #define INTERACTION_LAYER_DELETE  0x0100    // 选手端删除图层
 #define INTERACTION_FIGURE 0x0101         // 选手端绘制一个图形
 #define INTERACTION_FIGURE_2  0x0102         // 选手端绘制两个图形
 #define INTERACTION_FIGURE_5  0x0103         // 选手端绘制五个图形
 #define INTERACTION_FIGURE_7  0x0104         // 选手端绘制七个图形
 #define EXT_CLIENT_CUSTOM_CHARACTER 0x0110  // 选手端绘制字符图形
 #define SENTRY_CMD 0x0120                   // 哨兵自主决策指令 TODO
 #define RADAR_CMD 0x0121                    // 雷达自主决策指令 TODO
