...
#define PLUCK_SPEED 5400
//#define PLUCK_SPEED 1000
#define PLUCK_MOTOR_ONE 1620 //单发弹丸机械角度
#define Yaw_Mid_Front 776
#define Pitch_Mid    4855
#define P_ADD_limit 20
...
typedef struct {
	eDeviceState Remote_State,IMU_State, Gimbal_State[GIMBAL_SUM], Shoot_State[FRIC_SUM], Pluck_State, Down_State, PC_State,Referee_State,VT03_State;
}DeviceStates;
 ...
 */
typedef struct{
	int8_t game_state;   //游戏状态 0--比赛外 1准备阶段  4--比赛中
...
/* 看门狗 */
extern WatchDog_TypeDef Remote_Dog, IMU_Dog, Gimbal_Dog[GIMBAL_SUM], Shoot_Dog[FRIC_SUM], Pluck_Dog, Down_Dog, PC_Dog,Referee_Dog,VT03_Dog;
